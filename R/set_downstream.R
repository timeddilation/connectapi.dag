...
#'
#' @param object A ConnectTask environment generated by \link[connectapi.dag]{connect_task}
#'     that you want to set downstream/dependent tasks for.
#' @param ... Any ConnectTasks to make downstream of `object`
#'
...
set_downstream <- function(object, ...) {
  stopifnot(inherits(object, "ConnectTask"))
  object$set_downstream(...)
}
